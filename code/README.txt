How to run octave on your Mac:
You need install octave from octave webside. Then type octave on your terimal. Then you just go to the folder which has .m file you want to run. Then you just type file name. You can run this file. For example, you want to run hello.m . you just need type hello on your octave.

milestone1:
Open your terimal and type octave command (if your PC have already installed octave) then type run hello.m. You should use cd to go to the folder wihch has hello.m file. Then you type hello on your octave. You can get hello world and 
y =
...
For run each progrom. you can go to octave then type file name which you want to run. For example, you can type p2_if on ocatave to run p2_if.m.
...
milestone3:
before run make, you need install octave on your PC.
For run each progrom. you can go to octave then type file name which you want to run. For example, you can type p3_single on ocatave to run p3_single.m.
...
For run each progrom. you can go to octave then type file name which you want to run. For example, you can type p4_main on ocatave to run p4_main. For this milestone, you can only run p4_main to get p4_BasicClass result.
...
beforerun make, you need install octave on your PC.
For run each progrom. you can go to octave then type file name which you want to run. For example, you can type p5_barGraph on ocatave to run p5_barGraph.m

p5_barGraph.m : it will show simple bar graph on your octave.

p5_plot2d.m : it will show simple 2d plot on your octave.

p5_plot3d.m : it will show simple 3d plot on your octave.

For unique stuff to octave/matlab, it muste be it will easy to draw different graph for your data. So we are here show very basic graph for octave and matlab
